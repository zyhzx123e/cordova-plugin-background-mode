...
public class BackgroundMode extends CordovaPlugin {
    ...
    private void startService()
    {
        ...
        try {
            ...
            System.out.println("background mode startService ec:"+e.getMessage());
        }
    ...
    private void stopService()
    {
        try{
            ...
            System.out.println("background mode stopService ec:"+ec.getMessage());
        }
    ...
    private void fireEvent (Event event, String params)
    {
        try{
            ...
            System.out.println("background mode fireEvent ec:"+ec.getMessage());
        }
